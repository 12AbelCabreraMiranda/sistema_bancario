<?php
	//session_start(); //SESION START ANDA HACIENDO CONFLICTO <-----------------ANALISARLO BIEN (TAMBIEN EL ID DPI QUITARLO UNICO PARA QUE FUNCIONE O PROBAR CON SESION START)
/*
	if (empty($_POST['name'])){
		...
		*/
		...
		//$cuenta_tipoCuenta = $_POST["tipo_cuenta"];
